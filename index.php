                    ...
                    <div class="box">
                        ...
                        <div class="box-align">
                            <button id="modal-1" class="mod">
                                <svg class="svg" width="60">
                                    <path d="M10 10 L60 10 L60 75 L50 90 L10 90 Z " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M50 90 L50 75 L60 75 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M14 69 L56 69 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M14 76 L45 76 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M18 61 L52 61 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M22 19 L49 19 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M14 25 L30 25 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <path d="M34 25 L52 25 " style="fill:none; stroke-width:2.5; stroke:rgb(12, 11, 116); "></path>
                                    <!-- CAR -->
                                    <path d="M22 50 L17 50 L17 40 L24 32 L38 32 L45 40 L50 40 S50 40 54 44 L54 50 L49 50 " style="fill:none; stroke-width:2.5; stroke:rgb(214, 149, 10); "></path>
                                    <circle cx="26" cy="50" r="4" stroke="rgb(214, 149, 10)" stroke-width="2" fill="none" />
                                    <circle cx="45" cy="50" r="4" stroke="rgb(214, 149, 10)" stroke-width="2" fill="none" />
                                    <path d="M30 50 L41 50 " style="fill:none; stroke-width:2.5; stroke:rgb(214, 149, 10) "></path>
                                    <path d="M24 32 L26 40 L45 40 " style="fill:none; stroke-width:2.5; stroke:rgb(214, 149, 10) "></path>
                            ...
                            <div id="myModal1" class="modal1">
                                ...
                                <div class="modal1-content">
                                    ...
                                    <form action="input.php" method="get">
                                        <fieldset class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control mod-input" placeholder="search..." name="input-1">
                                                <div class="input-group-prepend input-nav">
                                                    <span class="input-group-text mod-btn" id="basic-addon1">
                                                        <button class="input-btn" name="button-1" type="submit">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <path d="M14.3764 12.4769C16.0464 10.1337 15.8302 6.85958 13.728 4.75736C11.3848 2.41421 7.58586 2.41421 5.24271 4.75736C2.89957 7.10051 2.89957 10.8995 5.24271 13.2426C7.34494 15.3449 10.619 15.561 12.9622 13.8911L18.6777 19.6066L20.092 18.1924L14.3764 12.4769ZM12.3138 6.17157C13.8759 7.73367 13.8759 10.2663 12.3138 11.8284C10.7517 13.3905 8.21902 13.3905 6.65692 11.8284C5.09483 10.2663 5.09483 7.73367 6.65692 6.17157C8.21902 4.60948 10.7517 4.60948 12.3138 6.17157Z"
                                                                    fill="rgb(184, 183, 183)" />
                                                            </svg>
                            ...
                            <div id="myModal2" class="modal2">
                                <div class="modal2-content">
                                    ...
                                    <form action="input.php" method="get">
                                        <fieldset class="form-group">
                                            <div class="input-group">
                                                <input type="text" class="form-control mod-input" placeholder="search..." name="input-2">
                                                <div class="input-group-prepend input-nav">
                                                    <span class="input-group-text mod-btn" id="basic-addon1">
